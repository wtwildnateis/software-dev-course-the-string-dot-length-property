...
console.log("The length of " + '"' + stringOne + '"' + " is " + lengthOne); // Should output: 15
console.log("The length of " + '"' + stringTwo + '"' + " is " + lengthTwo); // Should output: 10
console.log("The length of " + '"' + stringThree  + '"' + " is " + lengthThree); // Should output: 0